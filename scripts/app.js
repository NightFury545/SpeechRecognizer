...
class webkitSpeechRecognizer {
  constructor() {
    // Ініціалізація об'єкта розпізнавання мовлення
  ...
  start() {
    // Початок розпізнавання мовлення, якщо воно ще не активне
  ...
  stop() {
    // Зупинка розпізнавання мовлення, якщо воно активне
    if (this.isRecognizing) {
  ...
  onResult(callback) {
    // Обробка результатів розпізнавання мовлення
  ...
  onError(callback) {
    // Обробка помилок розпізнавання мовлення
...
const requestFunc = () => {
  // Відправка тексту запитання до API OpenAI та обробка відповіді
...
const speech = () => {
  // Початок розпізнавання мовлення при натисканні кнопки
  // buttonGo.classList.add('animate-button');
  speechRecognizer.start();
};

speechRecognizer.onResult(function(result) {
  // Обробка результату розпізнавання мовлення
...
buttonStop.addEventListener('click', () => {
  // Зупинка синтезу мовлення при натисканні кнопки
